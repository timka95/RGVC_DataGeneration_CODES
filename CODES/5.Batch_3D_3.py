...
filename = '/project/ntimea/l2d2/IMAGE_PAIR_GT/CODES/Data_Generation/Matfiles/3D_EveryData.csv'
filename2 = '/project/ntimea/l2d2/IMAGE_PAIR_GT/CODES/Data_Generation/Matfiles/3D_EveryDataOUTPUT2.csv'

# OUTPUT
#savemathere = '/Volumes/TIMKA/NEW_CNN/matfiles/Baches_3DTest.mat'
savemathere = '/project/ntimea/l2d2/IMAGE_PAIR_GT/CODES/Data_Generation/Matfiles/Baches_3D_8.mat'
...
def calcbiggestid():
    while (len(check3dinbatch) > 0):
        max = 0
        biggestid = None
        for data in list(check3dinbatch.keys()):  # Create a copy of the keys
