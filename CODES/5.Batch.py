...
def checksame(data1,data2, indexdata):
    ...
    for i in range(len(indexdata)):
        ...
        if(data1_check_smallid == check_smallid and data1_check_thetarho[0] == check_thetarho[0] and data1_check_thetarho[1] == check_thetarho[1]):
            index1 = i
            data1isin = True
        if(data2_check_smallid == check_smallid and data2_check_thetarho[0] == check_thetarho[0] and data2_check_thetarho[1] == check_thetarho[1]):
            index2 = i
            data2isin = True
