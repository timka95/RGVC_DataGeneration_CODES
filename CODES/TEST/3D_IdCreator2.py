...
filename2 = '/project/ntimea/l2d2/IMAGE_PAIR_GT/CODES/Data_Generation/Matfiles/3D_EveryData.csv'

# OUTPUT
#filepath = '/Volumes/TIMKA/NEW_CNN/matfiles/3D_EveryDataOUTPUT2.csv'
filepath = '/project/ntimea/l2d2/IMAGE_PAIR_GT/CODES/Data_Generation/Matfiles/3D_EveryDataOUTPUT2.csv'
