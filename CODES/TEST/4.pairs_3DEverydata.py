...
for data in (csvdata):
    ...
    for elem in range(len(image3d)):
        ...
        for already in range (len(array3d)):
            check = image3d[elem]
            if(array3d[already][0] == check[0] and array3d[already][1] == check[1] and array3d[already][2] == check[2] and array3d[already][3] == check[3] and array3d[already][4] == check[4] and array3d[already][5] == check[5]):
                benne = True
