...
csvpathfile = "/project/ntimea/l2d2/IMAGE_PAIR_GT/CODES/Data_Generation/Matfiles/osszesitett_3D.csv"  # The last image indicates how many images are in the batch
filename = "/project/ntimea/l2d2/IMAGE_PAIR_GT/CODES/Data_Generation/Matfiles/osszesitett_images.csv"
